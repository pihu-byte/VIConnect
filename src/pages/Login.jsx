        ...
        <div className="font-display bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center">
            <div className="flex min-h-screen w-full flex-col lg:flex-row">
                ...
                <div className="relative hidden w-full flex-col justify-center bg-gradient-to-br from-[#2563EB] to-[#4F46E5] p-12 lg:flex lg:w-1/2 xl:p-24">
                    <div className="absolute inset-0 opacity-10" data-alt="Subtle geometric cube pattern overlay" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=2000&auto=format&fit=crop')" }}></div>
                    ...
                    <div className="relative mt-16 aspect-video w-full overflow-hidden rounded-2xl shadow-2xl" data-alt="Illustration of students working together on laptops">
                        <img alt="Collaborative Students" className="h-full w-full object-cover" data-alt="Diverse group of students collaborating in a modern study space" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=1000&auto=format&fit=crop" />
                        ...
                        <div className="bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/50 dark:shadow-none rounded-2xl p-8 border border-slate-100 dark:border-slate-800">
                            ...
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                <div>
                                    ...
                                    <input
                                        className="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-3.5 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            className="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-3.5 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all pr-12"
                                ...
                                <button className="w-full rounded-lg bg-primary py-4 text-sm font-bold text-white shadow-lg shadow-primary/30 hover:bg-primary/90 transition-all transform active:scale-[0.98]" type="submit">
                                    Login
                                </button>
                            </form>
